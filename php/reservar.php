...
$consulta = "SELECT fecha_entrada,fecha_salida FROM reservas WHERE habitacion = '$room_actual'";
...
if (array_intersect($intervalo_fechas, $fechas_reservadas) ) {
	...
	include_once 'conexion2.php';
		$consulta = "INSERT INTO reservas (habitacion, fecha_entrada, fecha_salida, cantidad_personas,id) VALUES ('$room_actual','$fecha_ida','$fecha_vuelta','$num_personas','')";
