...
<body>
	<section id="mensaje_exitoso">
		<div class="mensaje">
			...
			echo "<a href='../ticket/ticket.php?id=$id_reserva&room=$room_actual&fecha_ida=$fecha_ida&fecha_vuelta=$fecha_vuelta&num_personas=$num_personas&price=$price&dni=$dni&cliente=$cliente&total=$total&dias=$dias' download='doc.pdf'>Descargar Comprobante</a>"; 
